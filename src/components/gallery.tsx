...
export default function Gallery() {
  ...
  const leftButtonStyle = `absolute top-1/2 left-0 transform -translate-y-1/2 bg-gray-800 bg-opacity-25 hover:bg-opacity-50 rounded-full w-16 h-16 flex justify-center items-center text-white cursor-pointer`;
  const rightButtonStyle = `absolute top-1/2 right-0 transform -translate-y-1/2 bg-gray-800 bg-opacity-25 hover:bg-opacity-50 rounded-full w-16 h-16 flex justify-center items-center text-white cursor-pointer`;
